...
const proxy = {
  ...
  // 'GET /api/exam/': 'http://localhost:8080',
  // 'POST /api/exam/': 'http://localhost:8080',
  // 'GET /api/item/': 'http://localhost:8080',
  // 'POST /api/item/': 'http://localhost:8080',
  // 'PATCH /api/item/': 'http://localhost:8080',
  // 'DELETE /api/item/': 'http://localhost:8080',
  // 'GET /api/thinking/': 'http://localhost:8080',
  // 'DELETE /api/thinking/': 'http://localhost:8080',
  // 'GET /api/question/': 'http://localhost:8080',
  // 'POST /api/question/': 'http://localhost:8080',
  // 'PATCH /api/question/': 'http://localhost:8080',
  // 'DELETE /api/question/': 'http://localhost:8080',
  // 'GET /api/feedback/': 'http://localhost:8080',
  // 'DELETE /api/feedback/': 'http://localhost:8080',
  // 'GET /api/grade/': 'http://localhost:8080',
  // 'POST /api/grade/': 'http://localhost:8080',
  // 'PATCH /api/grade/': 'http://localhost:8080',
  // 'DELETE /api/grade/': 'http://localhost:8080',
  // 'GET /api/grade/import': 'http://localhost:8080',
  // 'POST /api/grade/import': 'http://localhost:8080',
};
